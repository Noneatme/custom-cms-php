	...
	<body>
		...
		<div id="background">
			<?php
				...
				$userObject->checkIfUserHasGlobalRight(10);
			?>
			...
			<?php include include $_SERVER['DOCUMENT_ROOT']."/Home/Design/Main_Start.php"; ?> 
				...
				<p class="mainTextDoidSans">
						<?php
							...
							$GLOBALS["system"]->logger->outputLog("[ADMIN_HAUPTSEITE] Uebersichtsseite wurde bearbeitet - ".$userObject->getFullName());
		
							if(isset($_POST))
							{
								$text = $GLOBALS["system"]->getDatabaseClass()->escapeString($_POST['hauptseite']);
								$GLOBALS["system"]->getDatabaseClass()->query("UPDATE tblsystem SET Hauptseite = '$text';");
							}
