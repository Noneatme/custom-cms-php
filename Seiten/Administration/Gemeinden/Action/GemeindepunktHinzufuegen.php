			...
			<?php include $_SERVER['DOCUMENT_ROOT']."/Home/Design/Main_Start.php"; ?> 
				...
				<p class="mainTextDoidSans">
					<?php
						...
						if(isset($name) && isset($plz))
						{
							$result = $GLOBALS["system"]->getDatabaseClass()->query("INSERT INTO tblort(Ort, PLZ) VALUES ('$name', '$plz');");
							if(isset($result))
							{
								$GLOBALS["system"]->logger->outputLog("[ADMIN_GEMEINDE] Gemeindepunkt '$name'(PLZ: '$plz') wurde angelegt - ".$userObject->getFullName());
