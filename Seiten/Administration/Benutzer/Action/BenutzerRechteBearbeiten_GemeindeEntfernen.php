<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<?php include $_SERVER['DOCUMENT_ROOT']."/Home/Klassen/AdminCheck.php" ?>
		...
		{
			$recht			= $_POST['list'];
			$userObject2->removeBetreuteGemeindenRecht($recht);

			$GLOBALS["system"]->logger->outputLog("[ADMIN_BENUTZER] Benutzer '".$userObject2->getFullName()."' wurde BetreuteGemeindenRecht entzogen -> '$recht' - ".$userObject->getFullName());
