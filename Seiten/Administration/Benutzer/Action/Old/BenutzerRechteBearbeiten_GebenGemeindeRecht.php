			...
			<?php include $_SERVER['DOCUMENT_ROOT']."/Home/Design/Main_Start.php"; ?> 
				...
				<p class="mainTextDoidSans">
					<?php
						...
						{
							$recht			= $_POST['list'];
							$userObject2->addGemeindeRecht($recht);
							
							$GLOBALS["system"]->logger->outputLog("[ADMIN_BENUTZER] Benutzer '".$userObject2->getFullName()."' wurde GemeindeRecht gegeben -> '$recht' - ".$userObject->getFullName());
						}
					?>
