<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<?php include $_SERVER['DOCUMENT_ROOT']."/Home/Klassen/AdminCheck.php" ?>
		...
		{
			$recht			= $_POST['list'];
			$userObject2->removeGlobalRecht($recht);

			$GLOBALS["system"]->logger->outputLog("[ADMIN_BENUTZER] Benutzer '".$userObject2->getFullName()."' wurde GlobalRecht entzogen -> '$recht' - ".$userObject->getFullName());
