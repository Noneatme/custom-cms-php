		...
		<div id="background">
			...
			<?php include $_SERVER['DOCUMENT_ROOT']."/Home/Design/Main_Start.php"; ?> 
				...
				<p class="mainTextDoidSans">
					<br>
					Bitte w&auml;hlen Sie einen Benutzer aus der Liste aus, deren Rechte Sie dann anschlie&szlig;end bearbeiten m&ouml;chten.<br><br>
					<center>
					<form action="Action/BenutzerRechteBearbeiten.php" method="POST">
						<select name="BenutzerRechteBearbeiten" size="10" required="true">
						<?php
