	...
	<body>
		...
		<div id="background">
			...
			<?php include $_SERVER['DOCUMENT_ROOT']."/Home/Design/Main_Start.php"; ?> 
				...
				<?php
					$GLOBALS["system"]->logger->outputLog("[SYSADMIN] Systemadministrationsbereich wurde betreten - ".$userObject->getFullName());
				
				?>
				
				<p class="mainTextDoidSans">
					<br>
					Bitte w&auml;hlen Sie einen Unterpunkt aus dem Men&uuml; aus.
